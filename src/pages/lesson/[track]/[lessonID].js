          ...
          >
            {!lesson ? (
              ...
              <>
                <Content mt={5}>
                  <Tooltip
                    label={lesson.difficulty.shortDescription}
                    shouldWrapChildren
                    fontSize="md"
                    bg="gray.300"
                    placement="bottom"
                    ...
                    arrowSize={15}
                  >
                    <DifficultyBox color={lesson.difficulty.hexCodeColor}>
                      {lesson.difficulty.name} Lesson
                    </DifficultyBox>
                  </Tooltip>
                  <Flex
                    mt={2}
                  ...
                  >
                    {!nextLessons ? (
                      ...
                      Object.keys(nextLessons).map((key, index) => (
                        <CheckListItem
                          key={nextLessons[key].nameHeader}
                          info={nextLessons[key]}
              ...
              <>
                <Box>
                  ...
                  {!lesson.hasNextPage ? (
                    <>
                      <Text>
                        This is the last lesson of this track. Come back often
                        to see if more are added.
                      </Text>
                    </>
                  ) : (
                    <>
...
function CheckListItem({ info, track, lessonID }) {
  ...
  return (
    <Button
      ...
      borderRadius={0}
      backgroundColor="#ffe8e9"
      borderLeft="5px #ff9598 solid"
      _hover={{ bg: "#ffd7d9", borderColor: "#e35d61" }}
      _active={{ borderColor: "#e35d61" }}
    >
